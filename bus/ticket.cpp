...
void Ticket::bookTicket()
{
    ...
    else
    {
        ...
        {
            if (strcmpi(b.getfrom(), from) == 0 && strcmpi(b.getto(), to) == 0)
            {
                b.showBusDetails();
                chk = 1;
            }
        ...
        else
        {
            ...
            while (!busFileStream.eof())
            {
                if (strcmpi(b.getfrom(), from) == 0 && strcmpi(b.getto(), to) == 0 && strcmp(b.getbusNo(), bNo) == 0)
                {
